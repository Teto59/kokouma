...
export function KokoumaApp() {
  ...
  return <div className="app-shell">
    ...
    {selectedPlace && <PlaceDrawer place={selectedPlace} data={data!} current={current} onClose={() => setSelectedPlaceId(undefined)} onReview={() => requireAuth("review")} onDelete={() => setModal("delete-place")} onProfile={(id) => { setProfileId(id); setView("people"); setSelectedPlaceId(undefined); }} />}
